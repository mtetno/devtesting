...
final class LoginController {
	...
	// UserDetails altlogin(@RequestParam("username") final String username,
	...
	// String getEncryptedPass(@PathVariable("password") String
	// password,@PathVariable("theKey") String theKey) {
	// String encoDestring = subscriptionsRepository.getEncodedPassword(password,
	// theKey);
	// return encoDestring;
	// }

	// @GetMapping("/getDecryptedPass/{password}/{theKey}")
	// String getDecryptedPass(@PathVariable("password") String
	// encPassword,@PathVariable("theKey") String theKey) {
	// String encoDestring =
	// Util.getString(subscriptionsRepository.getDecodePassword(encPassword,
	// theKey));
	// return encoDestring;
	// }
	...
	// public boolean forgotPassword(@PathVariable(value="username") String
	// username) throws TestAppException, MessagingException {
	// logger.info("changing the password");
	// try {
	// User user = userRepo.findByUserName(username).get();
	// Subscriptions userCompany =
	// subscriptionsRepository.findById(user.getCompanyId()).get();
	...
	// append("Your password for Login: ").append(user.getUserName()).append(" is
	// ").append(newPass)
	// .append(Util.HTML_NEXT_LINE_STR).append(Util.HTML_NEXT_LINE_STR).
