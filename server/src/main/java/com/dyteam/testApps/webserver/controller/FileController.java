...
import com.dyteam.testApps.webserver.message.ResponseFile;
import com.dyteam.testApps.webserver.message.ResponseMessage;
import com.dyteam.testApps.webserver.service.FileStorageService;
...
public class FileController {
    ...
    @PostMapping("/upload/{tokenId}")
    public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file,
            @PathVariable(value = "tokenId") String tokenId) {
        String message = "";
        try {
            storageService.store(tokenId, file);
