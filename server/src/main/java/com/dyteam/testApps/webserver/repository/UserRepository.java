...
public interface UserRepository extends CrudRepository<User, Long> {
	...
	// @Modifying
	// @Transactional
	// @Query("update User u set u.userName = :userName,u.contact = :contact," + " u.address = :address"
	...
	// Integer update(String fName, String lName, String contact, Integer userType, String email, String address,
	// 		Long userId);
